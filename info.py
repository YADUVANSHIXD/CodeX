...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002224752949').split()]
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_to_open_movielink/21")
TUTORIAL2 = environ.get("TUTORIAL2", "https://t.me/How_to_open_movielink/15")
...
SHORTENER_API = environ.get("SHORTENER_API", "cb6243bee96a21ea399e214f1484a7de4652edc9")
...
SHORTENER_API3 = environ.get("SHORTENER_API3", "f77801ed4eff0432bf20e14c9a005d0f00418211")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "sdlinks.in")
