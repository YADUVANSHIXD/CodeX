...
›› sᴛᴇᴘ 𝟹 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href='https://shortxlinks.com/ref/Pradeep'>SʜᴏʀᴛXʟɪɴᴋꜱ</a> ᴏʀ <a href='https://sdlinks.in/ref/Pradeep'>SDʟɪɴᴋꜱ</a>. [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]

›› sᴛᴇᴘ 𝟺 : ɴᴏᴡ ꜱᴇᴛ ʏᴏᴜʀ ꜱʜᴏʀᴛɴᴇʀ, ᴛᴜᴛᴏʀɪᴀʟ, ꜰꜱᴜʙ ᴀɴᴅ ʟᴏɢ ᴄʜᴀɴɴᴇʟ.

›› sᴛᴇᴘ 𝟻 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href='https://github.com/YaduvanshiXD/Auto-Filter-Bot/blob/main/README.md'>ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ</a>.
...
आप आज ᴠᴇʀɪғɪᴇᴅ नहीं हैं, कृपया ᴠᴇʀɪғʏ पर क्लिक करें और अगली ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ तक फ़ाइले प्राप्त करें ।
...
अब आप अगले <code>{}</code> तक ᴜɴʟɪᴍɪᴛᴇᴅ मूवी प्राप्त कर सकते हैं।
...
आप ᴠᴇʀɪғɪᴇᴅ नहीं हैं, कृपया ᴠᴇʀɪғʏ बटन पर टैप करें और अगले ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ तक असीमित फ़ाइले प्राप्त करें ।
...
यदि आप आज ᴠᴇʀɪғɪᴇᴅ नहीं हैं, तो ᴠᴇʀɪғʏ बटन पर टैप करें और अगले पूरे दिन के लिए असीमित फ़ाइलें प्राप्त करें।
...
अब आप अगले पूरे दिन के लिए ᴜɴʟɪᴍɪᴛᴇᴅ मूवी प्राप्त कर सकते हैं
